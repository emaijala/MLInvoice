function update_stock_balance(translations)
{
  ...
  buttons[translations["save"]] = function() { save_stock_balance(translations); };
  buttons[translations["close"]] = function() { $("#update_stock_balance").dialog("close"); };
  $("#update_stock_balance").dialog({ modal: true, width: 400, height: 220, resizable: false, zIndex: 900,
    buttons: buttons,

  ...
  <div class="form">
    ...
    <div class="form_container ui-widget-content">
      ...
      <form id="form_upload" enctype="multipart/form-data" action="base_logo.php" method="POST">
        ...
        <div class="long"><input name="logo" type="file"></div>
        <div class="form_buttons" style="clear: both">
          <input type="submit" value="<?php echo $GLOBALS['locBaseSaveLogo']?>">
        </div>
      </form>
      <form id="form_erase" enctype="multipart/form-data" action="base_logo.php" method="POST">
        <input type="hidden" name="func" value="clear">
        <input type="hidden" name="id" value="<?php echo $baseId?>">
        <div class="form_buttons" style="clear: both">
          <input type="submit" value="<?php echo $GLOBALS['locBaseEraseLogo']?>">
        </div>
      </form>
    </div>
  </div>

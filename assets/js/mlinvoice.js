...
var MLInvoice = (function CreateMLInvoice() {
  ...
  function createDataTablesTotalFooter(dt, columns)
  {
    var api = dt.api();
  ...
  {
    addTranslations(config.translations);
    _dispatchNotePrintStyle = config.dispatchNotePrintStyle;
    _offerStates = config.offerStates;
  ...
  return {
    ...
    addTranslation,
    addTranslations,
    getDispatchNotePrintStyle,
    getDateRangePickerDefaults,
    isOfferStatus,
    isPaidStatus,
    translate,
    formatCurrency,

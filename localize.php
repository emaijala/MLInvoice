...
EOT;
  ...
  $GLOBALS['locPrintGrouping'] = 'Välisummat';
  $GLOBALS['locPrintGroupingNone'] = 'Ei mitään';
  $GLOBALS['locPrintGroupingState'] = 'Tiloittain';
  $GLOBALS['locPrintGroupingMonth'] = 'Kuukausittain';

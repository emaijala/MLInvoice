...
ALTER TABLE vllasku_product CHANGE COLUMN discount discount decimal(3,1) NULL;

ALTER TABLE vllasku_invoice_row CHANGE COLUMN discount discount decimal(3,1) NULL;
 ...
 * @link     http://labs.fi/mlinvoice.eng.php
 */
class PrintTemplateRepository extends EntityRepository
{
    /**
     * Get by ID.
     *
    ...
    /**
     * Find active templates for a given type.
     *
     * @param string $type
     * @return array
     */
    ...
    {
        return $this->findBy(['type' => $type, 'inactive' => 0]);
    }
}

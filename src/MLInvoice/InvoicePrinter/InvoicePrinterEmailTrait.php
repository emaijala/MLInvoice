...
trait InvoicePrinterEmailTrait
{
     ...
     * @return void
     */
    protected function setMailer(Mailer $mailer): void
    {
        $this->mailer = $mailer;
    }
    ...
    public function printInvoice()
    {
        ...
        if (!$send || !$this->emailFrom || !$this->emailTo || !$this->emailSubject
            ...
            $this->showEmailForm(
                $send ? $this->translator->translate('EmailFillRequiredFields') : ''
            );
            return;
        }
    ...
    {
        echo htmlPageStart($this->translator->translate('SendEmail'));
        ?>
<body>
    <div class="pagewrapper mb-4">
        ...
        <div id="email_form_container" class="container-fluid form_container">
            <h1><?php echo $this->translator->translate('SendEmail')?></h1>
            <?php
            if ($errorMsg) {
            ...
            <form method="POST" id="email_form">
                ...
                <div class="medium_label"><?php echo $this->translator->translate('EmailBody')?></div>
                <div class="field">
                ...
                if (!isset($this->printParams['attachment'])
                    ...
                    foreach ($filenames as $i => $filename) {
                        ...
                        <div class="medium_label">
                            <?php echo $i === 0 ? $this->translator->translate('EmailAttachments') : ''?>
                        </div>
                ...
                <div class="form_buttons">
                    <button type="button" class="btn btn-primary form-submit" data-set-field="email_send=1">
                        <?php echo $this->translator->translate('Send')?>
                    </button>
                    <button type="button" class="btn btn-secondary" data-form-cancel>
                        <?php echo $this->translator->translate('Cancel')?>
                    </button>
...
$(document).ready(function() {
    ...
    protected function sendEmail($printout, $attachments)
    {
        ...
        if (!$result) {
            $this->showEmailForm($this->mailer->getErrorMessage());
            return;
        }

...
?>
  ...
  <div class="form_container ui-widget-content ui-helper-clearfix">
    ...
    <div class="unlimited_label"><h1><?php echo $GLOBALS['locProductStockReport']?></h1></div>
    ...
    <div class="medium_label"></div><div class="field"><input type="checkbox" name="purchase_price" value="1"> <?php echo $GLOBALS['locOnlyProductsWithPurchasePrice']?></div>

...
INSERT INTO vllasku_invoice (id, name, company_id, invoice_no, real_invoice_no, invoice_date, due_date, payment_date, ref_number, state_id, reference, base_id) VALUES (1, 'Testi', 1, '100', 100, 20060530, 20060613, NULL, '', 1, '', 1);

INSERT INTO vllasku_invoice_row (id, invoice_id, description, type_id, pcs, price, row_date, vat, order_no) VALUES (1, 1, 'Testirivi 1', 3, 12.00, 150.00, 20060515, 22, 5);

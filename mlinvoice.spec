...
%files
%defattr(-,root,root,-)
%doc LICENSE README.md create_database.sql
%config(noreplace) %{_sysconfdir}/httpd/conf.d/%{name}.conf
%attr(2755,root,apache) %dir %{_sysconfdir}/%{name}
%{_datadir}/%{name}

%changelog
* The 29 Jan 2026 Ere Maijala <ere@labs.fi> - 2.4.2
- updated for version 2.4.2
* Sat 24 Jan 2026 Ere Maijala <ere@labs.fi> - 2.4.1
- updated for version 2.4.1
* Sat 3 Jan 2026 Ere Maijala <ere@labs.fi> - 2.4.0
- updated for version 2.4.0
* Tue 3 Jun 2025 Ere Maijala <ere@labs.fi> - 2.3.3
- updated for version 2.3.3
* Tue 21 Jan 2025 Ere Maijala <ere@labs.fi> - 2.3.2
...
* Sat 11 Nov 2023 Ere Maijala <ere@labs.fi> - 2.2.0
- updated for version 2.2.0
* Sun 2 Apr 2023 Ere Maijala <ere@labs.fi> - 2.1.2
